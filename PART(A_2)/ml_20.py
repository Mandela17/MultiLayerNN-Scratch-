...
class NeuralNetwork():
	...
	def train(self, training_set_inputs, training_set_outputs, number_of_training_iterations):
		...
		for iteration in range(number_of_training_iterations):
			...
			# for i in range(len(training_set_inputs)):
				...
				print("squared_error")
				print(squared_error)
				del4 = 2*((training_set_outputs[i] - output))*self.derivative_tanh(output)
				# print("del4")
				# print(del4)
	...
	def test(self,weights1,weights2,weights3,training_set_inputs, training_set_outputs, number_of_training_iterations):
		cost2=np.zeros(number_of_training_iterations)
		for iteration in range(number_of_training_iterations):
			for i in range(len(training_set_inputs)):
			# for i in range(len(training_set_inputs)):
...
if __name__ == "__main__":
	...
	ax.set_title('Tanh_in-sample error changes with Iterations in SGD')
	fig.savefig('Tanh_in-sample error changes with Iterations in SGD.png') 
	...
	ax.set_title('Tanh_Out_of_sample_Error changes with Iterations in SGD')
	fig.savefig('Tanh_Out_of_sample_Error changes with Iterations in SGD.png')
